...
export const filmStills: GalleryItem[] = [
  ...
  { src: '/film/dinners-ready-1.jpg', alt: 'Black-and-white close-up of a curly-haired boy with a wary, downcast expression', edge: "Dinner's Ready! · 2024", caption: "A son caught in his father's temper. Dinner's Ready! (2024) is a silent narrative short that asks what happens when we let our own agenda consume us. This close-up holds the boy's fear in the moment before everything boils over." },
