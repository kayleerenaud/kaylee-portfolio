...
export const filmStills: GalleryItem[] = [
  { src: '/film/collateral-calamity-1.jpg', alt: 'Four young adults peek warily around a stone corner on a New York street', edge: 'Collateral Calamity · 2024', caption: "The crew checks the coast. <em>Collateral Calamity</em> (2024) is my short comedy about a group of young adults trying to hide a body in New York. Shot on iPhone. I wrote, directed, and scored it." },
