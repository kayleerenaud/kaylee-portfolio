...
export const filmStills: GalleryItem[] = [
  { src: '/film/collateral-calamity-1.jpg', alt: 'Four young adults peek warily around a stone corner on a New York street', edge: 'Collateral Calamity · 2024', caption: "The crew checks the coast. <em>Collateral Calamity</em> (2024), my comedy about young adults hiding a body in New York. Shot on iPhone; written, directed, and scored by me." },
  { src: '/film/collateral-calamity-2.jpg', alt: 'A low-angle shot of characters wrestling something on a Manhattan street', edge: 'Collateral Calamity · 2024', caption: "When the plan goes sideways. A scramble on the street from <em>Collateral Calamity</em> (2024), shot on iPhone and written, directed, and scored by me." },
  { src: '/film/dinners-ready-1.jpg', alt: 'Black-and-white close-up of a curly-haired boy with a wary, downcast expression', edge: "Dinner's Ready! · 2024", caption: "A son under his father's temper. <em>Dinner's Ready!</em> (2024) is my silent short about what happens when our own agenda consumes us. Written and directed by me." },
  { src: '/film/dinners-ready-2.jpg', alt: 'Black-and-white kitchen scene with a father, a son eating, and a mother', edge: "Dinner's Ready! · 2024", caption: "The reconciliation, back in the kitchen. From <em>Dinner's Ready!</em> (2024), written and directed by me." },
  { src: '/film/wind-dry-grass-1.jpg', alt: 'Two men stand facing each other across a desolate field of dry grass under an overcast sky', edge: 'A Wind In Dry Grass · 2023', caption: "Two men, perhaps the last on earth. <em>A Wind In Dry Grass</em> (2023) is my adaptation of my own short story. Written and directed by me." },
  { src: '/film/wind-dry-grass-2.jpg', alt: 'A young man clutches an old portable radio in a barren, windswept landscape', edge: 'A Wind In Dry Grass · 2023', caption: "The crackle that starts the journey. From <em>A Wind In Dry Grass</em> (2023), adapted from my short story. Written and directed by me." },
  { src: '/film/take-him-out-1.jpg', alt: 'A lone figure on the Brooklyn waterfront at dawn, Brooklyn Bridge and Manhattan skyline behind, with a hand-drawn animated overlay', edge: 'Take Him Out! · 2024', caption: "An agent's target turns out to be her date. <em>Take Him Out!</em> is my silent short with hand-drawn comic-book overlays, shot in Dumbo at 4am. Written and directed by me." },
  { src: '/film/take-him-out-2.jpg', alt: 'A silhouetted figure walking under the Manhattan Bridge archway in Dumbo, Brooklyn', edge: 'Take Him Out! · 2024', caption: "Under the bridge in Dumbo. From <em>Take Him Out!</em>, my hand-animated silent spy short. Written and directed by me." },
];
...
export const upcomingFilm = {
  ...
  note: 'A hospital janitor is mistaken for a nurse<br class="br-desk">in the maternity ward on his first day.',
};
