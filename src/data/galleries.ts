...
export const filmStills: GalleryItem[] = [
  ...
  { src: '/film/take-him-out-1.jpg', alt: 'A lone figure on the Brooklyn waterfront at dawn, Brooklyn Bridge and Manhattan skyline behind, with a hand-drawn animated overlay', edge: 'Take Him Out! · 2024', caption: "An agent at the edge of the city. Take Him Out!, my silent short with comic-book overlays I animated by hand, follows an agent whose target turns out to be her date. Shot in Dumbo at 4am. Written and directed by me." },
  { src: '/film/take-him-out-2.jpg', alt: 'A silhouetted figure walking under the Manhattan Bridge archway in Dumbo, Brooklyn', edge: 'Take Him Out! · 2024', caption: "Under the bridge in Dumbo. From Take Him Out!, my hand-animated silent spy short. Written and directed by me." },
];
