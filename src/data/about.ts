...
export const blurb: string[] = [
  "I'm a Brooklyn-based storyteller drawn to character-driven narratives, with an enduring love of creating for young audiences. Across film, theater, marketing, live production, and wardrobe, I have contributed to two feature films, over twenty stage productions, and thirty short films.",
  "I plotted out my first play with untrained pointer fingers, clicking slowly on the chunky keys of my family's PC. I must have been eight, certainly no younger than seven, and I had never seen a play let alone been trained to write one, but no one corrected me (or my spelling), so I let my imagination run wild. What began as a whimsical escape became my way of processing the world. Today, whether I'm writing a script, sewing a costume, or framing a shot, it's the same work, and I'm glad you're here to see some of it.",
];
