...
export const blurb: string[] = [
  "I've been writing since before I could properly type, filling a <em>purple notebook</em> with wolf princesses and children who lived in tunnels beneath the dry South Jersey lawns. That notebook eventually made room for a viewfinder and a sewing table, but the instinct never changed: I build worlds, and I try to make them places worth staying.",
  "I work mostly for kids and families, not because it's easier but because I remember needing stories that <em>trusted me</em>. I grew up moving between two very different households, leaning on the heroes I found in books and films to carry me from one to the other. Children can hold <em>grief and wonder</em> in the same frame without needing it explained, and that is who I make things for: my younger self, my younger siblings and cousins, and the grown-ups who still remember being that kid. Whether I'm writing a script, sewing a costume, or framing a shot, it's the same work, and I'm glad you're here to see some of it.",
];
